...
import net.karma.tutorialmod.item.custom.IronCassing;
...
public class ModItems {
    ...
    public static final Item Iron_Cassing = registerItem("iron_cassing", new IronCassing(new FabricItemSettings()));
